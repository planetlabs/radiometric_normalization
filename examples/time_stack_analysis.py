...
time_stack_paths = ['radiometric_normalization_reference_test.LC81350432014251LGN00_all_crop.TIF',
...
reference_path = 'time_stack_output.tif'
result_path = 'output_time_stack_analysis.tif'
time_stack.generate(time_stack_paths, output_path=reference_path, method='identity', image_nodata=0)
